...
export const Privacy: React.FC = () => (
  <div className="py-16 px-4 max-w-3xl mx-auto">
    ...
    <div className="text-slate-600 space-y-4">
      <p>At Typing-Practice.online, we value your privacy. This policy explains how we collect and use your data.</p>
...
export const Terms: React.FC = () => (
  <div className="py-16 px-4 max-w-3xl mx-auto">
    ...
    <div className="text-slate-600 space-y-4">
      <p>By using Typing-Practice.online, you agree to the following terms:</p>
